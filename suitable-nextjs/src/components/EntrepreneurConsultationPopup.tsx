...
export default function EntrepreneurConsultationPopup({
  ...
  const consultationOptions = {
    online: { price: 350, name: 'Online Entrepreneur Consultation' },
    'in-person': { price: 600, name: 'In-Person Entrepreneur Consultation' },
  };
  ...
  const handleBookConsultation = () => {
    ...
    addToCart({
      id: `entrepreneur-consultation-${selectedType}`,
      name: option.name,
      price: option.price,
      type: selectedType,
    });
      ...
      <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-yellow-500 mb-3">
            Entrepreneur & SME Consultation
          </h3>
          <p className="text-gray-300 text-sm mb-4">
            Get expert guidance from experienced entrepreneurs. Choose your preferred consultation type:
          </p>
        </div>
